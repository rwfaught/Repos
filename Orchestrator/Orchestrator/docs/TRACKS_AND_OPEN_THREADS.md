...
- RAG, reminders, web lookup implementation, lightweight answer productization,
  ...
  open.
- Productized coordinator CLI/UI, service/API/UI, and live worker dispatch
  remain open.
