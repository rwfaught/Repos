...
- RAG, reminders, web lookup implementation, lightweight answer productization,
  service/API/UI, provider/model routing, route execution, and production
  readiness remain open.
- Productized coordinator UI/CLI and live worker dispatch remain open.
