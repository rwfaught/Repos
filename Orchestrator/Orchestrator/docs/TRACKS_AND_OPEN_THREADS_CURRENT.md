...
- The durable audit authority is
  `docs/GOVERNED_RESEARCH_CROSS_DOMAIN_GENERALITY_AUDIT_DECISION.md`. The next
  candidate boundary is bounded Governed Research V1 design; public-source
  proof remains blocked pending that design and separate authorization, and
  research implementation remains unauthorized.
...
| Governed-research investigation | ACTIVE_REUSABLE_WORK_PATTERN_TRACK | `CROSS_DOMAIN_GENERALITY_AUDIT=COMPLETED_CTO_RATIFIED`; `GOVERNED_RESEARCH_V1_DESIGN_GATE=READY_WITH_NAMED_PRECONDITIONS`. The durable audit decision preserves neutral-core limits, adapter/application-layer distinction, and named preconditions. Bounded design is the next candidate; public-source proof remains blocked pending design and separate authorization, and research implementation remains unauthorized. |
