...
| Founder Cockpit sidecar | ACTIVE_ADVISORY_SIDECAR | `FOUNDER_COCKPIT_FIXTURE_INFORMATION_MODEL_AND_INFORMED_COMPREHENSION_VALIDATION_DURABLE`: the tool-neutral specification is ratified; the eight-file fictional fixture package is durable on `main` at `704d0eca31a26e54ea95018f0584d53c5f61e444`; canonical plus four degraded variants completed informed, non-blind founder review; and the accepted six-unit information model remains intact. This proves information-model and informed-comprehension behavior only, not visual hierarchy, independent-user comprehension, accessibility, implementation, live data, API, persistence, project-management behavior, product-wedge selection, platform choice, or production readiness. Roadmap Phase 2 remains active and incomplete. The next ranked candidate is `FOUNDER_COCKPIT_STATIC_VISUAL_HIERARCHY_PROTOTYPE`, a separate fictional, read-only, tool-neutral boundary, not implementation authorization. The Founder Cockpit remains distinct from the Dossier Workspace. No architectural lock-in, Phase 387 resumption, platform, or Codex Sites authorization is implied. |
...
| Founder Cockpit durable fixture sidecar | ACTIVE_ADVISORY_SIDECAR | Durable eight-file fictional, non-authoritative, read-only fixture package with accepted informed, non-blind founder review at `704d0eca31a26e54ea95018f0584d53c5f61e444`. It proves information-model and informed-comprehension behavior only; no visual, independent-user, accessibility, implementation, live-data, API, persistence, project-management, product-wedge, architectural-lock-in, platform, Codex Sites, Phase 387, or production-readiness proof/authorization is present. | `FOUNDER_COCKPIT_STATIC_VISUAL_HIERARCHY_PROTOTYPE` under a separate fictional, read-only, tool-neutral boundary; not implementation authorization. | `docs/founder_cockpit_fixtures/README.md` |
